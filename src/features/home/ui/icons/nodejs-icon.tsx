...
/**
 * Devicon `nodejs/nodejs-original.svg` (MIT, devicon v2.17.0) — see
 ...
 *
 * The three `linearGradient` ids are namespaced (`nodejs-icon-*`,
 * upstream ids were the bare `a`/`b`/`c`) because this icon and
 * `php-icon.tsx` (also upstream id `a`) both render inline in the
 * same skills-section DOM — unprefixed ids would collide and one of
 * the two icons would silently pick up the other's gradient.
 */
